/**
 * Generate a random hex color, excluding a small set of low-contrast colors.
 */
...
/**
 * Deterministically map a user id to one of the bright collaboration colors,
 * so the same user always gets the same cursor/avatar color.
 */
