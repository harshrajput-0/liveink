...
export interface LiveInkLoaderDrawProps {
...
/**
 * LiveInk loader — dark-theme only. The pen-nib outline traces itself
 ...
 */
const LiveInkLoaderDraw: React.FC<LiveInkLoaderDrawProps> = ({
  size = 80,
  speed = 1.8,
  colorStart = "#818CF8",
  colorEnd = "#22D3EE",
  ...
  const drawAnim = `liveink-draw-${suffix}`;
  const detailAnim = `liveink-fade-hold-${suffix}`;
  const resetAnim = `liveink-reset-${suffix}`;
...
export default LiveInkLoaderDraw;

/*
Usage:

  import LiveInkLoaderDraw from "./LiveInkLoaderDraw";

  <LiveInkLoaderDraw size={48} />
  <LiveInkLoaderDraw size={64} speed={1.4} />
*/
