    ...
    return (
        <Select value={userType} onValueChange={(type: UserType) => accessChangeHandler(type)} disabled={disabled}>
            ...
            <SelectContent position='popper' align='end' sideOffset={6} className='border-none bg-dark-200! shadow-lg!'>
                <SelectItem value='viewer' className='my-0.5! cursor-pointer! rounded-full! bg-dark-200! py-2! pl-3! pr-8! text-blue-100! transition-colors! data-[highlighted]:bg-dark-500 data-[highlighted]:text-white focus:bg-dark-300! focus:text-blue-100!'>can view</SelectItem>
                <SelectItem value='editor' className='my-0.5! cursor-pointer! rounded-full! bg-dark-200! py-2! pl-3! pr-8! text-blue-100! transition-colors! data-[highlighted]:bg-dark-500 data-[highlighted]:text-white focus:bg-dark-300! focus:text-blue-100!'>can edit</SelectItem>
            </SelectContent>
